...
/* Ascon Instructions */
#define MATCH_ASCONSIGMA0H 0x4000702b
#define MASK_ASCONSIGMA0H 0xfe00707f
#define MATCH_ASCONSIGMA0L 0x702b
#define MASK_ASCONSIGMA0L 0xfe00707f
#define MATCH_ASCONSIGMA1H 0x4200702b
#define MASK_ASCONSIGMA1H 0xfe00707f
#define MATCH_ASCONSIGMA1L 0x200702b
#define MASK_ASCONSIGMA1L 0xfe00707f
#define MATCH_ASCONSIGMA2H 0x4400702b
#define MASK_ASCONSIGMA2H 0xfe00707f
#define MATCH_ASCONSIGMA2L 0x400702b
#define MASK_ASCONSIGMA2L 0xfe00707f
#define MATCH_ASCONSIGMA3H 0x4600702b
#define MASK_ASCONSIGMA3H 0xfe00707f
#define MATCH_ASCONSIGMA3L 0x600702b
#define MASK_ASCONSIGMA3L 0xfe00707f
#define MATCH_ASCONSIGMA4H 0x4800702b
#define MASK_ASCONSIGMA4H 0xfe00707f
#define MATCH_ASCONSIGMA4L 0x800702b
#define MASK_ASCONSIGMA4L 0xfe00707f
/* Kyber Instructions */
...
/* Ascon Instructions */
DECLARE_INSN(asconsigma0h, MATCH_ASCONSIGMA0H, MASK_ASCONSIGMA0H)
DECLARE_INSN(asconsigma0l, MATCH_ASCONSIGMA0L, MASK_ASCONSIGMA0L)
DECLARE_INSN(asconsigma1h, MATCH_ASCONSIGMA1H, MASK_ASCONSIGMA1H)
DECLARE_INSN(asconsigma1l, MATCH_ASCONSIGMA1L, MASK_ASCONSIGMA1L)
DECLARE_INSN(asconsigma2h, MATCH_ASCONSIGMA2H, MASK_ASCONSIGMA2H)
DECLARE_INSN(asconsigma2l, MATCH_ASCONSIGMA2L, MASK_ASCONSIGMA2L)
DECLARE_INSN(asconsigma3h, MATCH_ASCONSIGMA3H, MASK_ASCONSIGMA3H)
DECLARE_INSN(asconsigma3l, MATCH_ASCONSIGMA3L, MASK_ASCONSIGMA3L)
DECLARE_INSN(asconsigma4h, MATCH_ASCONSIGMA4H, MASK_ASCONSIGMA4H)
DECLARE_INSN(asconsigma4l, MATCH_ASCONSIGMA4L, MASK_ASCONSIGMA4L)

/* Kyber Instructions */
DECLARE_INSN(kybercbd2, MATCH_KYBERCBD2, MASK_KYBERCBD2)
DECLARE_INSN(kybercbd3, MATCH_KYBERCBD3, MASK_KYBERCBD3)
DECLARE_INSN(kybercompress, MATCH_KYBERCOMPRESS, MASK_KYBERCOMPRESS)
DECLARE_INSN(kyberadd, MATCH_KYBERADD, MASK_KYBERADD)
DECLARE_INSN(kybermul, MATCH_KYBERMUL, MASK_KYBERMUL)
DECLARE_INSN(kybersub, MATCH_KYBERSUB, MASK_KYBERSUB)
